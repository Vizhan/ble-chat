...
object BleServerManager {
    ...
    fun init(context: Application?, bleServerCallback: BleServerCallback) {
        ...
        this.bleAdapter ?: throw RuntimeException("Bluetooth not supported in this device")

        this.bleAdvertiser = bleAdapter?.bluetoothLeAdvertiser
        this.bleAdvertiser ?: throw RuntimeException("Error initializing BLE Advertiser")
        ...
        this.bleServerManagerCallback = bleServerCallback
